...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_WeatherWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_WeatherWidget_t qt_meta_stringdata_WeatherWidget = {
    {
        QT_MOC_LITERAL(0, 13),  // "WeatherWidget"
        QT_MOC_LITERAL(14, 14),  // "weatherUpdated"
        QT_MOC_LITERAL(29, 0),  // ""
        QT_MOC_LITERAL(30, 7),  // "weather"
        QT_MOC_LITERAL(38, 4),  // "temp"
        QT_MOC_LITERAL(43, 14)   // "onNetworkReply"
    },
    "WeatherWidget",
    "weatherUpdated",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_WeatherWidget[] = {
...
Q_CONSTINIT const QMetaObject WeatherWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_WeatherWidget.offsetsAndSizes,
...
void WeatherWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->weatherUpdated((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        ...
        {
            using _t = void (WeatherWidget::*)(const QString & , int );
            if (_t _q_method = &WeatherWidget::weatherUpdated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WeatherWidget::weatherUpdated(const QString & _t1, int _t2)
{
